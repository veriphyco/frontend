...
export function MenuInner() {
  ...
  return (
    <>
      <MenuItem title={'VERIPHY ADMIN'} to='/dashboard' />   
      {/* <MenuItem title='Layout Builder' to='/builder' /> */}

      <MenuInnerWithSub title='' to='/crafted' menuPlacement='bottom-start' menuTrigger='click'>
      ...
      <MenuInnerWithSub title='' to='/apps' menuPlacement='bottom-start' menuTrigger='click'>
        {/* PAGES */}
        <MenuInnerWithSub
          title='Chat 2'
          to='/apps/chat'
